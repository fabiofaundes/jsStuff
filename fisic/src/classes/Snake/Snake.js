...
export class Snake {
    constructor(headCoordinate, length, width){
        ...
        for(var i = 0; i < length; i++){
            var coordinate = new Coordinate(headCoordinate.x - (width*i) -i, headCoordinate.y)
    ...
    incPos(){
        ...
        switch(this.direction){                    
            case Directions.UP:
                ...
                newY = this.body[0].coordinate.y-this.width-1;
                break;
            case Directions.RIGHT:
                newX = this.body[0].coordinate.x+this.width+1;
